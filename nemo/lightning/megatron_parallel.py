...
from nemo.lightning._strategy_lib import init_lightning_module
        ...
        if vp_size is not None:
            if (
                ...
                for i in range(1, vp_size):
                    ...
                    _model = init_lightning_module(_pipeline[0], copy=True)
            ...
            if mpu.model_parallel_is_initialized() and mpu.get_data_parallel_rank() == 0:
                ...
                msg = (
                    ...
                    f"{_strategy_lib._calc_number_of_params(_pipeline)}"     # noqa: SLF001
                )
                logging.info(msg)
